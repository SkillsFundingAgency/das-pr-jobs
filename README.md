...
* Firewall rules for ports 5671 and 5672 should open for developer profile to allow connection to Azure Service Bus, raise an IT request with network security team
